...
[![Lint Status](https://github.com/EluminaGroup/terraform-aws-ecs-app/workflows/Lint/badge.svg)](https://github.com/EluminaGroup/terraform-aws-ecs-app/actions)
[![LICENSE](https://img.shields.io/github/license/EluminaGroup/terraform-aws-ecs-app)](https://github.com/EluminaGroup/terraform-aws-ecs-app/blob/master/LICENSE)

This terraform module is an AWS ECS Application Module for Scheduler without an Application Load Balancer(ALB), designed to be used with `EluminaGroup/terraform-aws-ecs` (https://github.com/EluminaGroup/terraform-aws-ecs).
...
The following resources will be created:
 ...
 - Cloudwatch Log Groups
      ...
      - Export to a S3 Bucket - Whether to mark the log group to export to an S3 bucket (needs the module terraform-aws-log-exporter (https://github.com/EluminaGroup/terraform-aws-log-exporter) to be deployed in the account/region)
...
Apache 2 Licensed. See [LICENSE](https://github.com/EluminaGroup/terraform-aws-ecs-app/blob/master/LICENSE) for full details.
